...
@NamedQueries({
        ...
        @NamedQuery(name="findClientSessionsOrderedById", query="select sess from PersistentClientSessionEntity sess where sess.offline = :offline and sess.userSessionId >= :firstSessionId and sess.userSessionId <= :lastSessionId order by sess.userSessionId")
})
